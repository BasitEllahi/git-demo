...
/***/ function(module, exports, __webpack_require__) {
	...
	var _objectsBird = __webpack_require__(6);

	var _objectsBird2 = _interopRequireDefault(_objectsBird);

	var _objectsGround = __webpack_require__(7);
	...
	var Play = (function (_Phaser$State) {
		...
		_createClass(Play, [{
			...
			value: function create() {
				...
				this.ground = new _objectsGround2['default'](this.game, 0, 400);
...
/***/ function(module, exports) {
	...
	var Ground = (function (_Phaser$TileSprite) {
		...
		function Ground(game, x, y) {
			...
			_get(Object.getPrototypeOf(Ground.prototype), 'constructor', this).call(this, game, x, y, 'ground');
			this.game.physics.arcade.enableBody(this);
